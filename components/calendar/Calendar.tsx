...
const Calendar: React.FC = () => {
	...
	const handleDateSelect = (selectInfo: DateSelectArg) => {
		console.log("handle select", selectInfo)
		resetModalFields()
	...
	const handleEventClick = (clickInfo: EventClickArg) => {
		console.log("handle event clieck", clickInfo)
	...
	const handleAddOrUpdateEvent = () => {
		console.log("handleAddOrUpdateEvent")
		if (selectedEvent) {
		...
		<div className="rounded-2xl border  border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
			...
			>
				<div className="flex flex-col px-2 overflow-y-auto custom-scrollbar">
					<div>
						<h5 className="mb-2 font-semibold text-gray-800 modal-title text-theme-xl dark:text-white/90 lg:text-2xl">{selectedEvent ? "Edit Event" : "Add Event"}</h5>
						<p className="text-sm text-gray-500 dark:text-gray-400">Plan your next big moment: schedule or edit an event to stay on track</p>
					</div>
					<div className="mt-8">
						<div>
							<div>
